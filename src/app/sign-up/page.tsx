      ...
      <div className="card" style={{ padding: 28 }}>
        ...
        <form onSubmit={onSubmit}>
          <div style={{ marginBottom: 12 }}>
            <label htmlFor="name" style={{ fontSize: 12, color: "var(--muted)" }}>
              Name
            </label>
            <input
              id="name"
          ...
          <div style={{ marginBottom: 12 }}>
            <label htmlFor="email" style={{ fontSize: 12, color: "var(--muted)" }}>
              Email
            </label>
            <input
              id="email"
          ...
          <div style={{ marginBottom: 16 }}>
            <label htmlFor="password" style={{ fontSize: 12, color: "var(--muted)" }}>
